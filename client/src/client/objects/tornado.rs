...
impl Tornado {
    ...
    pub fn draw(&self, ctx: &DrawContext) {
        ...
        let debris_offsets: &[(f32, f32)] = &[(-3.0, 2.0), (24.0, 4.0), (-2.0, 10.0), (23.0, 12.0)];
        ...
        draw_rectangle(
            ...
            14.0 * s,
            2.0 * s,
            Color::from_rgba(200, 175, 110, 140),
        );
        draw_rectangle(
            ox + 6.0 * s,
            oy + 25.0 * s,
            10.0 * s,
            2.0 * s,
            Color::from_rgba(200, 175, 110, 100),
        );
        draw_rectangle(
            ox + 8.0 * s,
            oy + 26.0 * s,
            6.0 * s,
            1.0 * s,
            Color::from_rgba(200, 175, 110, 70),
        );
    }
}
